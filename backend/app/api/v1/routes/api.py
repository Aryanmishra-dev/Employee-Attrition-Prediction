...
templates = Jinja2Templates(
    directory=str(Path(__file__).resolve().parents[5] / "frontend" / "src")
)
...
async def predict_employee(request: Request) -> HTMLResponse | JSONResponse:
    ...
    if is_htmx(request):
        ...
        return templates.TemplateResponse(request, "components/features/prediction_result.html", context)
...
async def batch_preview(request: Request, file: UploadFile = File(...)) -> HTMLResponse | JSONResponse:
    ...
    return templates.TemplateResponse(request, "components/features/batch_preview.html", context)
...
async def batch_predict(request: Request, file: UploadFile = File(...)) -> HTMLResponse | JSONResponse:
    ...
    if is_htmx(request):
        ...
        return templates.TemplateResponse(request, "components/features/batch_results.html", context)
    return JSONResponse(content=response.model_dump(mode="json"))
...
async def add_employee_note(
    ...
    return templates.TemplateResponse(request, "components/features/employee_notes.html", context)
...
async def job_role_options(
    ...
    return templates.TemplateResponse(request, "components/features/job_role_select.html", context)
...
async def analytics_department(
    ...
    if partial == "heatmap":
        ...
        return templates.TemplateResponse(request, "components/features/analytics_heatmap.html", context)
...
async def analytics_trends(
    ...
    if partial:
        return templates.TemplateResponse(
            request,
            "components/features/analytics_trends.html",
...
async def analytics_top_features(
    ...
    if partial:
        return templates.TemplateResponse(
            request,
            "components/features/analytics_top_features.html",
            {"request": request, "payload": payload},
        )
    return JSONResponse(content=payload)
...
async def analytics_age_groups(
    ...
    if partial:
        return templates.TemplateResponse(
            request,
            "components/features/analytics_age_groups.html",
            {"request": request, "payload": payload},
        )
    return JSONResponse(content=payload)
...
async def analytics_income_scatter(
    ...
    if partial:
        return templates.TemplateResponse(
            request,
            "components/features/analytics_income_scatter.html",
            {"request": request, "payload": payload},
        )
    return JSONResponse(content=payload)
