...
from shared.constants.constants import PRIMARY_NAV, build_form_sections
...
async def predict_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "pages/predict.html", context)
...
async def batch_predict_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "pages/batch_predict.html", context)
...
async def employee_profile_page(request: Request, employee_id: str) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "pages/employee_profile.html", context)
...
async def model_info_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "pages/model_info.html", context)
...
async def quick_predict_modal(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "components/features/quick_predict_modal.html", context)
